...
wss.on("connection", function(ws){
  ...
  ws.on("message", function incoming(message){
    ...
    if(type == "0"){
      ...
      players.push(player);
      if(gameInstances[gameInstance.length - 1].players.length == 4){
        gameInstance[game]
      }
    }
    ...
    if(type == "2"){
      ...
      let message = "2-" + currPlayer.playern + "=" + data + "=" + currPlayer.gameInstance.pawns[currPlayer.playern - 1][parseInt(data) - 1];
